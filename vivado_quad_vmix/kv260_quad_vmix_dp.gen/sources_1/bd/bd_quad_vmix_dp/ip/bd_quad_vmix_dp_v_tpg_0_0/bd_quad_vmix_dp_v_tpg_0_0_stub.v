...
// Command     : write_verilog -force -mode synth_stub -rename_top bd_quad_vmix_dp_v_tpg_0_0 -prefix
//               bd_quad_vmix_dp_v_tpg_0_0_ bd_quad_vmix_dp_v_tpg_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "bd_quad_vmix_dp_v_tpg_0_0,bd_quad_vmix_dp_v_tpg_0_0_v_tpg,{}" *) (* CORE_GENERATION_INFO = "bd_quad_vmix_dp_v_tpg_0_0,bd_quad_vmix_dp_v_tpg_0_0_v_tpg,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=v_tpg,x_ipVersion=8.2,x_ipCoreRevision=6,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CTRL_ADDR_WIDTH=8,C_S_AXI_CTRL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_quad_vmix_dp_v_tpg_0_0_v_tpg,Vivado 2024.2" *) (* hls_module = "yes" *) 
module bd_quad_vmix_dp_v_tpg_0_0(s_axi_CTRL_AWADDR, s_axi_CTRL_AWVALID, 
