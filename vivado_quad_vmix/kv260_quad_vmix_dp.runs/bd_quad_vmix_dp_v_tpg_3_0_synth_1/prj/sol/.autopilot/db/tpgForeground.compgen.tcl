...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bd_quad_vmix_dp_v_tpg_3_0_tpgForeground_whiYuv_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorR_val_dout { I 8 vector } boxColorR_val_empty_n { I 1 bit } boxColorR_val_read { O 1 bit } boxColorR_val_num_data_valid { I 3 vector } boxColorR_val_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorG_val_dout { I 8 vector } boxColorG_val_empty_n { I 1 bit } boxColorG_val_read { O 1 bit } boxColorG_val_num_data_valid { I 3 vector } boxColorG_val_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { boxColorB_val_dout { I 8 vector } boxColorB_val_empty_n { I 1 bit } boxColorB_val_read { O 1 bit } boxColorB_val_num_data_valid { I 3 vector } boxColorB_val_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val7_c_din { O 11 vector } width_val7_c_full_n { I 1 bit } width_val7_c_write { O 1 bit } width_val7_c_num_data_valid { I 3 vector } width_val7_c_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_val17_c_din { O 8 vector } colorFormat_val17_c_full_n { I 1 bit } colorFormat_val17_c_write { O 1 bit } colorFormat_val17_c_num_data_valid { I 3 vector } colorFormat_val17_c_fifo_cap { I 3 vector } } \
} "
}
