...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val7_dout { I 11 vector } width_val7_empty_n { I 1 bit } width_val7_read { O 1 bit } width_val7_num_data_valid { I 3 vector } width_val7_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_val17_dout { I 8 vector } colorFormat_val17_empty_n { I 1 bit } colorFormat_val17_read { O 1 bit } colorFormat_val17_num_data_valid { I 3 vector } colorFormat_val17_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fid_in_val9_dout { I 1 vector } fid_in_val9_empty_n { I 1 bit } fid_in_val9_read { O 1 bit } fid_in_val9_num_data_valid { I 3 vector } fid_in_val9_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { field_id_val8_dout { I 16 vector } field_id_val8_empty_n { I 1 bit } field_id_val8_read { O 1 bit } field_id_val8_num_data_valid { I 3 vector } field_id_val8_fifo_cap { I 3 vector } } \
} "
}
