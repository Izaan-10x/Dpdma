...
entity bd_quad_vmix_dp_v_tpg_3_0_v_tpgHlsDataFlow is
port (
...
architecture behav of bd_quad_vmix_dp_v_tpg_3_0_v_tpgHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_boxSize_val20_c_din : STD_LOGIC_VECTOR (15 downto 0);
    signal entry_proc_U0_boxSize_val20_c_write : STD_LOGIC;
    signal entry_proc_U0_boxColorR_val21_c_din : STD_LOGIC_VECTOR (7 downto 0);
    signal entry_proc_U0_boxColorR_val21_c_write : STD_LOGIC;
    signal entry_proc_U0_boxColorG_val22_c_din : STD_LOGIC_VECTOR (7 downto 0);
    signal entry_proc_U0_boxColorG_val22_c_write : STD_LOGIC;
    signal entry_proc_U0_boxColorB_val23_c_din : STD_LOGIC_VECTOR (7 downto 0);
    signal entry_proc_U0_boxColorB_val23_c_write : STD_LOGIC;
    ...
    signal tpgBackground_U0_bckgndYUV_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal tpgBackground_U0_bckgndYUV_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tpgForeground_U0_height_val4_c_din : STD_LOGIC_VECTOR (10 downto 0);
    signal tpgForeground_U0_height_val4_c_write : STD_LOGIC;
    signal tpgForeground_U0_width_val7_c_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal boxSize_val20_c_full_n : STD_LOGIC;
    signal boxSize_val20_c_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal boxSize_val20_c_empty_n : STD_LOGIC;
    signal boxSize_val20_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal boxSize_val20_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorR_val21_c_full_n : STD_LOGIC;
    signal boxColorR_val21_c_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal boxColorR_val21_c_empty_n : STD_LOGIC;
    signal boxColorR_val21_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorR_val21_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorG_val22_c_full_n : STD_LOGIC;
    signal boxColorG_val22_c_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal boxColorG_val22_c_empty_n : STD_LOGIC;
    signal boxColorG_val22_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorG_val22_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorB_val23_c_full_n : STD_LOGIC;
    signal boxColorB_val23_c_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal boxColorB_val23_c_empty_n : STD_LOGIC;
    signal boxColorB_val23_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal boxColorB_val23_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        boxSize_val20 : IN STD_LOGIC_VECTOR (15 downto 0);
        boxSize_val20_c_din : OUT STD_LOGIC_VECTOR (15 downto 0);
        boxSize_val20_c_full_n : IN STD_LOGIC;
        boxSize_val20_c_write : OUT STD_LOGIC;
        boxSize_val20_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        boxSize_val20_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorR_val21 : IN STD_LOGIC_VECTOR (7 downto 0);
        boxColorR_val21_c_din : OUT STD_LOGIC_VECTOR (7 downto 0);
        boxColorR_val21_c_full_n : IN STD_LOGIC;
        boxColorR_val21_c_write : OUT STD_LOGIC;
        boxColorR_val21_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorR_val21_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorG_val22 : IN STD_LOGIC_VECTOR (7 downto 0);
        boxColorG_val22_c_din : OUT STD_LOGIC_VECTOR (7 downto 0);
        boxColorG_val22_c_full_n : IN STD_LOGIC;
        boxColorG_val22_c_write : OUT STD_LOGIC;
        boxColorG_val22_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorG_val22_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorB_val23 : IN STD_LOGIC_VECTOR (7 downto 0);
        boxColorB_val23_c_din : OUT STD_LOGIC_VECTOR (7 downto 0);
        boxColorB_val23_c_full_n : IN STD_LOGIC;
        boxColorB_val23_c_write : OUT STD_LOGIC;
        boxColorB_val23_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        boxColorB_val23_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0) );
    end component;


    component bd_quad_vmix_dp_v_tpg_3_0_tpgBackground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_tpgForeground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w1_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w48_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_start_for_tpgForeground_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_3_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component bd_quad_vmix_dp_v_tpg_3_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        boxSize_val20 => boxSize_val20,
        boxSize_val20_c_din => entry_proc_U0_boxSize_val20_c_din,
        boxSize_val20_c_full_n => boxSize_val20_c_full_n,
        boxSize_val20_c_write => entry_proc_U0_boxSize_val20_c_write,
        boxSize_val20_c_num_data_valid => boxSize_val20_c_num_data_valid,
        boxSize_val20_c_fifo_cap => boxSize_val20_c_fifo_cap,
        boxColorR_val21 => boxColorR_val21,
        boxColorR_val21_c_din => entry_proc_U0_boxColorR_val21_c_din,
        boxColorR_val21_c_full_n => boxColorR_val21_c_full_n,
        boxColorR_val21_c_write => entry_proc_U0_boxColorR_val21_c_write,
        boxColorR_val21_c_num_data_valid => boxColorR_val21_c_num_data_valid,
        boxColorR_val21_c_fifo_cap => boxColorR_val21_c_fifo_cap,
        boxColorG_val22 => boxColorG_val22,
        boxColorG_val22_c_din => entry_proc_U0_boxColorG_val22_c_din,
        boxColorG_val22_c_full_n => boxColorG_val22_c_full_n,
        boxColorG_val22_c_write => entry_proc_U0_boxColorG_val22_c_write,
        boxColorG_val22_c_num_data_valid => boxColorG_val22_c_num_data_valid,
        boxColorG_val22_c_fifo_cap => boxColorG_val22_c_fifo_cap,
        boxColorB_val23 => boxColorB_val23,
        boxColorB_val23_c_din => entry_proc_U0_boxColorB_val23_c_din,
        boxColorB_val23_c_full_n => boxColorB_val23_c_full_n,
        boxColorB_val23_c_write => entry_proc_U0_boxColorB_val23_c_write,
        boxColorB_val23_c_num_data_valid => boxColorB_val23_c_num_data_valid,
        boxColorB_val23_c_fifo_cap => boxColorB_val23_c_fifo_cap);

    tpgBackground_U0 : component bd_quad_vmix_dp_v_tpg_3_0_tpgBackground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bckgndYUV_num_data_valid => tpgBackground_U0_bckgndYUV_num_data_valid,
        bckgndYUV_fifo_cap => tpgBackground_U0_bckgndYUV_fifo_cap,
    ...
    tpgForeground_U0 : component bd_quad_vmix_dp_v_tpg_3_0_tpgForeground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        boxSize_val_dout => boxSize_val20_c_dout,
        boxSize_val_empty_n => boxSize_val20_c_empty_n,
        boxSize_val_read => tpgForeground_U0_boxSize_val_read,
        boxSize_val_num_data_valid => boxSize_val20_c_num_data_valid,
        boxSize_val_fifo_cap => boxSize_val20_c_fifo_cap,
        boxColorR_val_dout => boxColorR_val21_c_dout,
        boxColorR_val_empty_n => boxColorR_val21_c_empty_n,
        boxColorR_val_read => tpgForeground_U0_boxColorR_val_read,
        boxColorR_val_num_data_valid => boxColorR_val21_c_num_data_valid,
        boxColorR_val_fifo_cap => boxColorR_val21_c_fifo_cap,
        boxColorG_val_dout => boxColorG_val22_c_dout,
        boxColorG_val_empty_n => boxColorG_val22_c_empty_n,
        boxColorG_val_read => tpgForeground_U0_boxColorG_val_read,
        boxColorG_val_num_data_valid => boxColorG_val22_c_num_data_valid,
        boxColorG_val_fifo_cap => boxColorG_val22_c_fifo_cap,
        boxColorB_val_dout => boxColorB_val23_c_dout,
        boxColorB_val_empty_n => boxColorB_val23_c_empty_n,
        boxColorB_val_read => tpgForeground_U0_boxColorB_val_read,
        boxColorB_val_num_data_valid => boxColorB_val23_c_num_data_valid,
        boxColorB_val_fifo_cap => boxColorB_val23_c_fifo_cap,
    ...
    MultiPixStream2AXIvideo_U0 : component bd_quad_vmix_dp_v_tpg_3_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    field_id_val8_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    fid_in_val9_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w1_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayId_val11_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    maskId_val12_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairX_val18_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairY_val19_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxSize_val20_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc_U0_boxSize_val20_c_din,
        if_full_n => boxSize_val20_c_full_n,
        if_write => entry_proc_U0_boxSize_val20_c_write,
        if_dout => boxSize_val20_c_dout,
        if_empty_n => boxSize_val20_c_empty_n,
        if_read => tpgForeground_U0_boxSize_val_read,
        if_num_data_valid => boxSize_val20_c_num_data_valid,
        if_fifo_cap => boxSize_val20_c_fifo_cap);

    boxColorR_val21_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc_U0_boxColorR_val21_c_din,
        if_full_n => boxColorR_val21_c_full_n,
        if_write => entry_proc_U0_boxColorR_val21_c_write,
        if_dout => boxColorR_val21_c_dout,
        if_empty_n => boxColorR_val21_c_empty_n,
        if_read => tpgForeground_U0_boxColorR_val_read,
        if_num_data_valid => boxColorR_val21_c_num_data_valid,
        if_fifo_cap => boxColorR_val21_c_fifo_cap);

    boxColorG_val22_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc_U0_boxColorG_val22_c_din,
        if_full_n => boxColorG_val22_c_full_n,
        if_write => entry_proc_U0_boxColorG_val22_c_write,
        if_dout => boxColorG_val22_c_dout,
        if_empty_n => boxColorG_val22_c_empty_n,
        if_read => tpgForeground_U0_boxColorG_val_read,
        if_num_data_valid => boxColorG_val22_c_num_data_valid,
        if_fifo_cap => boxColorG_val22_c_fifo_cap);

    boxColorB_val23_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc_U0_boxColorB_val23_c_din,
        if_full_n => boxColorB_val23_c_full_n,
        if_write => entry_proc_U0_boxColorB_val23_c_write,
        if_dout => boxColorB_val23_c_dout,
        if_empty_n => boxColorB_val23_c_empty_n,
        if_read => tpgForeground_U0_boxColorB_val_read,
        if_num_data_valid => boxColorB_val23_c_num_data_valid,
        if_fifo_cap => boxColorB_val23_c_fifo_cap);

    bckgndYUV_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w48_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c3_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c4_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    motionSpeed_val14_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c5_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayYUV_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w48_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c_U : component bd_quad_vmix_dp_v_tpg_3_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_tpgForeground_U0_U : component bd_quad_vmix_dp_v_tpg_3_0_start_for_tpgForeground_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component bd_quad_vmix_dp_v_tpg_3_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    tpgBackground_U0_bckgndYUV_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(bckgndYUV_fifo_cap),5))),32));
    tpgBackground_U0_bckgndYUV_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(bckgndYUV_num_data_valid),5))),32));
