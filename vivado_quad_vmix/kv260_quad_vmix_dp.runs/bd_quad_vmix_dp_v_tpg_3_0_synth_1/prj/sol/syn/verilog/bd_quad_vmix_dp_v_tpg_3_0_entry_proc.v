...
module bd_quad_vmix_dp_v_tpg_3_0_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        boxSize_val20,
        boxSize_val20_c_din,
        boxSize_val20_c_full_n,
        boxSize_val20_c_write,
        boxSize_val20_c_num_data_valid,
        boxSize_val20_c_fifo_cap,
        boxColorR_val21,
        boxColorR_val21_c_din,
        boxColorR_val21_c_full_n,
        boxColorR_val21_c_write,
        boxColorR_val21_c_num_data_valid,
        boxColorR_val21_c_fifo_cap,
        boxColorG_val22,
        boxColorG_val22_c_din,
        boxColorG_val22_c_full_n,
        boxColorG_val22_c_write,
        boxColorG_val22_c_num_data_valid,
        boxColorG_val22_c_fifo_cap,
        boxColorB_val23,
        boxColorB_val23_c_din,
        boxColorB_val23_c_full_n,
        boxColorB_val23_c_write,
        boxColorB_val23_c_num_data_valid,
        boxColorB_val23_c_fifo_cap
);
...
output  [15:0] boxSize_val20_c_din;
input   boxSize_val20_c_full_n;
output   boxSize_val20_c_write;
input  [2:0] boxSize_val20_c_num_data_valid;
input  [2:0] boxSize_val20_c_fifo_cap;
input  [7:0] boxColorR_val21;
output  [7:0] boxColorR_val21_c_din;
input   boxColorR_val21_c_full_n;
output   boxColorR_val21_c_write;
input  [2:0] boxColorR_val21_c_num_data_valid;
input  [2:0] boxColorR_val21_c_fifo_cap;
input  [7:0] boxColorG_val22;
output  [7:0] boxColorG_val22_c_din;
input   boxColorG_val22_c_full_n;
output   boxColorG_val22_c_write;
input  [2:0] boxColorG_val22_c_num_data_valid;
input  [2:0] boxColorG_val22_c_fifo_cap;
input  [7:0] boxColorB_val23;
output  [7:0] boxColorB_val23_c_din;
input   boxColorB_val23_c_full_n;
output   boxColorB_val23_c_write;
input  [2:0] boxColorB_val23_c_num_data_valid;
input  [2:0] boxColorB_val23_c_fifo_cap;
...
reg boxSize_val20_c_write;
reg boxColorR_val21_c_write;
reg boxColorG_val22_c_write;
reg boxColorB_val23_c_write;
...
reg    boxSize_val20_c_blk_n;
reg    boxColorR_val21_c_blk_n;
reg    boxColorG_val22_c_blk_n;
reg    boxColorB_val23_c_blk_n;
reg    ap_block_state1;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        boxColorB_val23_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorB_val23_c_write = 1'b1;
    end else begin
        boxColorB_val23_c_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        boxColorG_val22_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorG_val22_c_write = 1'b1;
    end else begin
        boxColorG_val22_c_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        boxColorR_val21_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxColorR_val21_c_write = 1'b1;
    end else begin
        boxColorR_val21_c_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        boxSize_val20_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        boxSize_val20_c_write = 1'b1;
    end else begin
        boxSize_val20_c_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((boxColorG_val22_c_full_n == 1'b0) | (boxColorR_val21_c_full_n == 1'b0) | (boxSize_val20_c_full_n == 1'b0) | (real_start == 1'b0) | (crossHairY_val19_c_full_n == 1'b0) | (crossHairX_val18_c_full_n == 1'b0) | (maskId_val12_c_full_n == 1'b0) | (ovrlayId_val11_c_full_n == 1'b0) | (fid_in_val9_c_full_n == 1'b0) | (field_id_val8_c_full_n == 1'b0) | (ap_done_reg == 1'b1) | (boxColorB_val23_c_full_n == 1'b0));
end

assign ap_ready = internal_ap_ready;

assign boxColorB_val23_c_din = boxColorB_val23;

assign boxColorG_val22_c_din = boxColorG_val22;

assign boxColorR_val21_c_din = boxColorR_val21;

assign boxSize_val20_c_din = boxSize_val20;
...
endmodule //bd_quad_vmix_dp_v_tpg_3_0_entry_proc
