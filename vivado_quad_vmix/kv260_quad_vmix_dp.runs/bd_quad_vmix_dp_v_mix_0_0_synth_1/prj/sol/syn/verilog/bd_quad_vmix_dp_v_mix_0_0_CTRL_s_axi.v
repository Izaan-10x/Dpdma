...
// ==============================================================
`timescale 1ns/1ps
module bd_quad_vmix_dp_v_mix_0_0_CTRL_s_axi
#(parameter
    ...
    output wire [15:0]                   layerAlpha_4,
    output wire [15:0]                   layerStartX_4,
    output wire [15:0]                   layerStartY_4,
    output wire [15:0]                   layerWidth_4,
    output wire [15:0]                   layerStride_4,
    output wire [15:0]                   layerHeight_4,
    output wire [7:0]                    layerScaleFactor_4,
...
localparam
    ...
    ADDR_LAYERALPHA_4_DATA_0       = 12'h500,
    ADDR_LAYERALPHA_4_CTRL         = 12'h504,
    ADDR_LAYERSTARTX_4_DATA_0      = 12'h508,
    ADDR_LAYERSTARTX_4_CTRL        = 12'h50c,
    ADDR_LAYERSTARTY_4_DATA_0      = 12'h510,
    ADDR_LAYERSTARTY_4_CTRL        = 12'h514,
    ADDR_LAYERWIDTH_4_DATA_0       = 12'h518,
    ADDR_LAYERWIDTH_4_CTRL         = 12'h51c,
    ADDR_LAYERSTRIDE_4_DATA_0      = 12'h520,
    ADDR_LAYERSTRIDE_4_CTRL        = 12'h524,
    ADDR_LAYERHEIGHT_4_DATA_0      = 12'h528,
    ADDR_LAYERHEIGHT_4_CTRL        = 12'h52c,
    ADDR_LAYERSCALEFACTOR_4_DATA_0 = 12'h530,
    ADDR_LAYERSCALEFACTOR_4_CTRL   = 12'h534,
...
//------------------------Local signal-------------------
    ...
    reg  [15:0]                   int_layerAlpha_4 = 'b0;
    reg  [15:0]                   int_layerStartX_4 = 'b0;
    reg  [15:0]                   int_layerStartY_4 = 'b0;
    reg  [15:0]                   int_layerWidth_4 = 'b0;
    reg  [15:0]                   int_layerStride_4 = 'b0;
    reg  [15:0]                   int_layerHeight_4 = 'b0;
    reg  [7:0]                    int_layerScaleFactor_4 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_LAYERALPHA_4_DATA_0: begin
                    rdata <= int_layerAlpha_4[15:0];
                end
                ADDR_LAYERSTARTX_4_DATA_0: begin
                    rdata <= int_layerStartX_4[15:0];
                end
                ADDR_LAYERSTARTY_4_DATA_0: begin
                    rdata <= int_layerStartY_4[15:0];
                end
                ADDR_LAYERWIDTH_4_DATA_0: begin
                    rdata <= int_layerWidth_4[15:0];
                end
                ADDR_LAYERSTRIDE_4_DATA_0: begin
                    rdata <= int_layerStride_4[15:0];
                end
                ADDR_LAYERHEIGHT_4_DATA_0: begin
                    rdata <= int_layerHeight_4[15:0];
                end
                ADDR_LAYERSCALEFACTOR_4_DATA_0: begin
                    rdata <= int_layerScaleFactor_4[7:0];
                end
...
assign layerAlpha_4       = int_layerAlpha_4;
assign layerStartX_4      = int_layerStartX_4;
assign layerStartY_4      = int_layerStartY_4;
assign layerWidth_4       = int_layerWidth_4;
assign layerStride_4      = int_layerStride_4;
assign layerHeight_4      = int_layerHeight_4;
assign layerScaleFactor_4 = int_layerScaleFactor_4;
...
// int_layerAlpha_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerAlpha_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERALPHA_4_DATA_0)
            int_layerAlpha_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerAlpha_4[15:0] & ~wmask);
    end
end

// int_layerStartX_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerStartX_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERSTARTX_4_DATA_0)
            int_layerStartX_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerStartX_4[15:0] & ~wmask);
    end
end

// int_layerStartY_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerStartY_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERSTARTY_4_DATA_0)
            int_layerStartY_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerStartY_4[15:0] & ~wmask);
    end
end

// int_layerWidth_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerWidth_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERWIDTH_4_DATA_0)
            int_layerWidth_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerWidth_4[15:0] & ~wmask);
    end
end

// int_layerStride_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerStride_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERSTRIDE_4_DATA_0)
            int_layerStride_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerStride_4[15:0] & ~wmask);
    end
end

// int_layerHeight_4[15:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerHeight_4[15:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERHEIGHT_4_DATA_0)
            int_layerHeight_4[15:0] <= (WDATA[31:0] & wmask) | (int_layerHeight_4[15:0] & ~wmask);
    end
end

// int_layerScaleFactor_4[7:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layerScaleFactor_4[7:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYERSCALEFACTOR_4_DATA_0)
            int_layerScaleFactor_4[7:0] <= (WDATA[31:0] & wmask) | (int_layerScaleFactor_4[7:0] & ~wmask);
    end
end
