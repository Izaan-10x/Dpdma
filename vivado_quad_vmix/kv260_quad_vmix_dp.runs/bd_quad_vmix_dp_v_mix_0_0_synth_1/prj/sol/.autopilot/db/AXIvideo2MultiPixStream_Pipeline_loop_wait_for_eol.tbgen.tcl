...
set C_modelArgList {
	{ axi_data_32_reload int 48 regular  }
	...
	{ axi_data_33_out int 48 regular {pointer 1}  }
	{ axi_last_40_out int 1 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_32_reload", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_33_out", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
 	{ "Name" : "axi_last_40_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_axis_video4_TVALID sc_in sc_logic 1 invld 3 } 
	{ axi_data_32_reload sc_in sc_lv 48 signal 0 } 
	{ select_ln3150 sc_in sc_lv 1 signal 1 } 
	{ eol_reload sc_in sc_lv 1 signal 2 } 
	{ s_axis_video4_TDATA sc_in sc_lv 48 signal 3 } 
	{ s_axis_video4_TREADY sc_out sc_logic 1 inacc 9 } 
	{ s_axis_video4_TKEEP sc_in sc_lv 6 signal 4 } 
	{ s_axis_video4_TSTRB sc_in sc_lv 6 signal 5 } 
	{ s_axis_video4_TUSER sc_in sc_lv 1 signal 6 } 
	{ s_axis_video4_TLAST sc_in sc_lv 1 signal 7 } 
	{ s_axis_video4_TID sc_in sc_lv 1 signal 8 } 
	{ s_axis_video4_TDEST sc_in sc_lv 1 signal 9 } 
	{ axi_data_33_out sc_out sc_lv 48 signal 10 } 
	{ axi_data_33_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ axi_last_40_out sc_out sc_lv 1 signal 11 } 
	{ axi_last_40_out_ap_vld sc_out sc_logic 1 outvld 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_32_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_32_reload", "role": "default" }} , 
 	...
 	{ "name": "axi_data_33_out", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_33_out", "role": "default" }} , 
 	{ "name": "axi_data_33_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_data_33_out", "role": "ap_vld" }} , 
 	{ "name": "axi_last_40_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "axi_last_40_out", "role": "default" }} , 
 	{ "name": "axi_last_40_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_last_40_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	axi_data_32_reload { ap_none {  { axi_data_32_reload in_data 0 48 } } }
	...
	axi_data_33_out { ap_vld {  { axi_data_33_out out_data 1 48 }  { axi_data_33_out_ap_vld out_vld 1 1 } } }
	axi_last_40_out { ap_vld {  { axi_last_40_out out_data 1 1 }  { axi_last_40_out_ap_vld out_vld 1 1 } } }
}
