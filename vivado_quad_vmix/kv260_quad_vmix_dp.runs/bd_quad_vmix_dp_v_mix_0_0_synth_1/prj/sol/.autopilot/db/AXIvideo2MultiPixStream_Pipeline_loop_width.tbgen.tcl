...
set C_modelArgList {
	{ sof_16 int 1 regular  }
	{ axi_last_38 int 1 regular  }
	{ axi_data_31 int 48 regular  }
	{ trunc_ln10 int 11 regular  }
	...
	{ axi_data_32_out int 48 regular {pointer 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "sof_16", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "axi_last_38", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "axi_data_31", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln10", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_32_out", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_axis_video4_TVALID sc_in sc_logic 1 invld 5 } 
	{ srcLayer4_din sc_out sc_lv 48 signal 4 } 
	{ srcLayer4_full_n sc_in sc_logic 1 signal 4 } 
	{ srcLayer4_write sc_out sc_logic 1 signal 4 } 
	{ srcLayer4_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ srcLayer4_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ sof_16 sc_in sc_lv 1 signal 0 } 
	{ axi_last_38 sc_in sc_lv 1 signal 1 } 
	{ axi_data_31 sc_in sc_lv 48 signal 2 } 
	{ trunc_ln10 sc_in sc_lv 11 signal 3 } 
	{ s_axis_video4_TDATA sc_in sc_lv 48 signal 5 } 
	{ s_axis_video4_TREADY sc_out sc_logic 1 inacc 11 } 
	{ s_axis_video4_TKEEP sc_in sc_lv 6 signal 6 } 
	{ s_axis_video4_TSTRB sc_in sc_lv 6 signal 7 } 
	{ s_axis_video4_TUSER sc_in sc_lv 1 signal 8 } 
	{ s_axis_video4_TLAST sc_in sc_lv 1 signal 9 } 
	{ s_axis_video4_TID sc_in sc_lv 1 signal 10 } 
	{ s_axis_video4_TDEST sc_in sc_lv 1 signal 11 } 
	{ eol_out sc_out sc_lv 1 signal 12 } 
	{ eol_out_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ axi_data_32_out sc_out sc_lv 48 signal 13 } 
	{ axi_data_32_out_ap_vld sc_out sc_logic 1 outvld 13 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_axis_video4_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "s_axis_video4_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "sof_16", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sof_16", "role": "default" }} , 
 	{ "name": "axi_last_38", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "axi_last_38", "role": "default" }} , 
 	{ "name": "axi_data_31", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_31", "role": "default" }} , 
 	{ "name": "trunc_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "trunc_ln10", "role": "default" }} , 
 	...
 	{ "name": "axi_data_32_out", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_32_out", "role": "default" }} , 
 	{ "name": "axi_data_32_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_data_32_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	sof_16 { ap_none {  { sof_16 in_data 0 1 } } }
	axi_last_38 { ap_none {  { axi_last_38 in_data 0 1 } } }
	axi_data_31 { ap_none {  { axi_data_31 in_data 0 48 } } }
	trunc_ln10 { ap_none {  { trunc_ln10 in_data 0 11 } } }
	...
	s_axis_video4_V_data_V { axis {  { s_axis_video4_TVALID in_vld 0 1 }  { s_axis_video4_TDATA in_data 0 48 } } }
	...
	s_axis_video4_V_dest_V { axis {  { s_axis_video4_TREADY in_acc 1 1 }  { s_axis_video4_TDEST in_data 0 1 } } }
	eol_out { ap_vld {  { eol_out out_data 1 1 }  { eol_out_ap_vld out_vld 1 1 } } }
	axi_data_32_out { ap_vld {  { axi_data_32_out out_data 1 48 }  { axi_data_32_out_ap_vld out_vld 1 1 } } }
}
