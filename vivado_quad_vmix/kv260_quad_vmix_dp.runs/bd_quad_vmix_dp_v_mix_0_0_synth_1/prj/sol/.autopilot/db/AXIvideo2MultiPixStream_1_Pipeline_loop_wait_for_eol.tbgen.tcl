...
set C_modelArgList {
	{ axi_data_25_reload int 48 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_25_reload", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ axi_data_25_reload sc_in sc_lv 48 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_25_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_25_reload", "role": "default" }} , 
...
set Spec2ImplPortList { 
	axi_data_25_reload { ap_none {  { axi_data_25_reload in_data 0 48 } } }
