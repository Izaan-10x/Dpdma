...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer1Rgb_dout { I 48 vector } srcLayer1Rgb_empty_n { I 1 bit } srcLayer1Rgb_read { O 1 bit } srcLayer1Rgb_num_data_valid { I 3 vector } srcLayer1Rgb_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer1x_din { O 48 vector } srcLayer1x_full_n { I 1 bit } srcLayer1x_write { O 1 bit } srcLayer1x_num_data_valid { I 32 vector } srcLayer1x_fifo_cap { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerWidth_1_val_c_din { O 16 vector } HwReg_layerWidth_1_val_c_full_n { I 1 bit } HwReg_layerWidth_1_val_c_write { O 1 bit } HwReg_layerWidth_1_val_c_num_data_valid { I 3 vector } HwReg_layerWidth_1_val_c_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerHeight_1_val_c_din { O 16 vector } HwReg_layerHeight_1_val_c_full_n { I 1 bit } HwReg_layerHeight_1_val_c_write { O 1 bit } HwReg_layerHeight_1_val_c_num_data_valid { I 3 vector } HwReg_layerHeight_1_val_c_fifo_cap { I 3 vector } } \
} "
}
