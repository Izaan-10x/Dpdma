...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out420 \
    op interface \
    ports { out420_dout { I 48 vector } out420_empty_n { I 1 bit } out420_read { O 1 bit } out420_num_data_valid { I 3 vector } out420_fifo_cap { I 3 vector } } \
} "
}
