...
set C_modelArgList {
	{ srcLayer0Yuv int 48 regular {fifo 0 volatile }  }
	{ height int 12 regular {ap_stable 0} }
	{ width int 12 regular {ap_stable 0} }
	{ layerEnableFlag int 1 regular {fifo 0}  }
	{ outLayer0 int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer0Yuv", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "outLayer0", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ srcLayer0Yuv_dout sc_in sc_lv 48 signal 0 } 
	...
	{ outLayer0_din sc_out sc_lv 48 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer0Yuv_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer0Yuv", "role": "dout" }} , 
 	...
 	{ "name": "outLayer0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "outLayer0", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0Yuv", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_84", "Port" : "srcLayer0Yuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "outLayer0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_84", "Port" : "outLayer0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_895_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_84", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_yuv2rgb_false_4_Pipeline_VITIS_LOOP_897_2_fu_84.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0Yuv { ap_fifo {  { srcLayer0Yuv_dout fifo_data_in 0 48 }  { srcLayer0Yuv_empty_n fifo_status 0 1 }  { srcLayer0Yuv_read fifo_port_we 1 1 }  { srcLayer0Yuv_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0Yuv_fifo_cap fifo_update 0 3 } } }
	...
	outLayer0 { ap_fifo {  { outLayer0_din fifo_data_in 1 48 }  { outLayer0_full_n fifo_status 0 1 }  { outLayer0_write fifo_port_we 1 1 }  { outLayer0_num_data_valid fifo_status_num_data_valid 0 32 }  { outLayer0_fifo_cap fifo_update 0 32 } } }
}
