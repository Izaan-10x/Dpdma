...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer2Rgb_dout { I 48 vector } srcLayer2Rgb_empty_n { I 1 bit } srcLayer2Rgb_read { O 1 bit } srcLayer2Rgb_num_data_valid { I 3 vector } srcLayer2Rgb_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer2x_din { O 48 vector } srcLayer2x_full_n { I 1 bit } srcLayer2x_write { O 1 bit } srcLayer2x_num_data_valid { I 32 vector } srcLayer2x_fifo_cap { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerWidth_2_val_c_din { O 16 vector } HwReg_layerWidth_2_val_c_full_n { I 1 bit } HwReg_layerWidth_2_val_c_write { O 1 bit } HwReg_layerWidth_2_val_c_num_data_valid { I 3 vector } HwReg_layerWidth_2_val_c_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerHeight_2_val_c_din { O 16 vector } HwReg_layerHeight_2_val_c_full_n { I 1 bit } HwReg_layerHeight_2_val_c_write { O 1 bit } HwReg_layerHeight_2_val_c_num_data_valid { I 3 vector } HwReg_layerHeight_2_val_c_fifo_cap { I 3 vector } } \
} "
}
