...
set C_modelArgList {
	{ srcLayer0 int 48 regular {fifo 0 volatile }  }
	{ height int 12 regular {ap_stable 0} }
	{ width int 12 regular {ap_stable 0} }
	{ layerEnableFlag int 1 regular {fifo 0}  }
	{ srcLayer0Yuv422 int 48 regular {fifo 1 volatile }  }
	{ HwReg_layerEnableFlag_0_val_c25 int 1 regular {fifo 1}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer0", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "srcLayer0Yuv422", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
 	{ "Name" : "HwReg_layerEnableFlag_0_val_c25", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ srcLayer0_dout sc_in sc_lv 48 signal 0 } 
	...
	{ srcLayer0Yuv422_din sc_out sc_lv 48 signal 4 } 
	...
	{ HwReg_layerEnableFlag_0_val_c25_din sc_out sc_lv 1 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c25_full_n sc_in sc_logic 1 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c25_write sc_out sc_logic 1 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c25_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ HwReg_layerEnableFlag_0_val_c25_fifo_cap sc_in sc_lv 3 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer0_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer0", "role": "dout" }} , 
 	...
 	{ "name": "srcLayer0Yuv422_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer0Yuv422", "role": "din" }} , 
 	...
 	{ "name": "HwReg_layerEnableFlag_0_val_c25_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c25", "role": "din" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c25_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c25", "role": "full_n" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c25_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c25", "role": "write" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c25_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c25", "role": "num_data_valid" }} , 
 	{ "name": "HwReg_layerEnableFlag_0_val_c25_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "HwReg_layerEnableFlag_0_val_c25", "role": "fifo_cap" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_420_to_422_false_2_Pipeline_VITIS_LOOP_76_2_fu_96", "Port" : "srcLayer0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer0Yuv422", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_420_to_422_false_2_Pipeline_VITIS_LOOP_76_2_fu_96", "Port" : "srcLayer0Yuv422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "HwReg_layerEnableFlag_0_val_c25", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_420_to_422_false_2_Pipeline_VITIS_LOOP_76_2_fu_96", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_420_to_422_false_2_Pipeline_VITIS_LOOP_76_2_fu_96.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0 { ap_fifo {  { srcLayer0_dout fifo_data_in 0 48 }  { srcLayer0_empty_n fifo_status 0 1 }  { srcLayer0_read fifo_port_we 1 1 }  { srcLayer0_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0_fifo_cap fifo_update 0 3 } } }
	height { ap_stable {  { height in_data 0 12 } } }
	width { ap_stable {  { width in_data 0 12 } } }
	layerEnableFlag { ap_fifo {  { layerEnableFlag_dout fifo_data_in 0 1 }  { layerEnableFlag_empty_n fifo_status 0 1 }  { layerEnableFlag_read fifo_port_we 1 1 }  { layerEnableFlag_num_data_valid fifo_status_num_data_valid 0 3 }  { layerEnableFlag_fifo_cap fifo_update 0 3 } } }
	srcLayer0Yuv422 { ap_fifo {  { srcLayer0Yuv422_din fifo_data_in 1 48 }  { srcLayer0Yuv422_full_n fifo_status 0 1 }  { srcLayer0Yuv422_write fifo_port_we 1 1 }  { srcLayer0Yuv422_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer0Yuv422_fifo_cap fifo_update 0 32 } } }
	HwReg_layerEnableFlag_0_val_c25 { ap_fifo {  { HwReg_layerEnableFlag_0_val_c25_din fifo_data_in 1 1 }  { HwReg_layerEnableFlag_0_val_c25_full_n fifo_status 0 1 }  { HwReg_layerEnableFlag_0_val_c25_write fifo_port_we 1 1 }  { HwReg_layerEnableFlag_0_val_c25_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerEnableFlag_0_val_c25_fifo_cap fifo_update 0 3 } } }
}
