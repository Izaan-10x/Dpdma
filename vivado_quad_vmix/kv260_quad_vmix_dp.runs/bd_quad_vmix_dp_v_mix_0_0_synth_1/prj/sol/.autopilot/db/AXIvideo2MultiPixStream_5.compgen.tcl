...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video1_TDATA { I 48 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video1_TKEEP { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video1_TSTRB { I 6 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer1_din { O 48 vector } srcLayer1_full_n { I 1 bit } srcLayer1_write { O 1 bit } srcLayer1_num_data_valid { I 3 vector } srcLayer1_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 148 \
    name HwReg_layerEnableFlag_1_val_c29 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerEnableFlag_1_val_c29 \
    op interface \
    ports { HwReg_layerEnableFlag_1_val_c29_din { O 1 vector } HwReg_layerEnableFlag_1_val_c29_full_n { I 1 bit } HwReg_layerEnableFlag_1_val_c29_write { O 1 bit } HwReg_layerEnableFlag_1_val_c29_num_data_valid { I 3 vector } HwReg_layerEnableFlag_1_val_c29_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 149 \
    name HwReg_layerWidth_1_val_c42 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerWidth_1_val_c42 \
    op interface \
    ports { HwReg_layerWidth_1_val_c42_din { O 16 vector } HwReg_layerWidth_1_val_c42_full_n { I 1 bit } HwReg_layerWidth_1_val_c42_write { O 1 bit } HwReg_layerWidth_1_val_c42_num_data_valid { I 3 vector } HwReg_layerWidth_1_val_c42_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 150 \
    name HwReg_layerHeight_1_val_c58 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerHeight_1_val_c58 \
    op interface \
    ports { HwReg_layerHeight_1_val_c58_din { O 16 vector } HwReg_layerHeight_1_val_c58_full_n { I 1 bit } HwReg_layerHeight_1_val_c58_write { O 1 bit } HwReg_layerHeight_1_val_c58_num_data_valid { I 3 vector } HwReg_layerHeight_1_val_c58_fifo_cap { I 3 vector } } \
} "
}
