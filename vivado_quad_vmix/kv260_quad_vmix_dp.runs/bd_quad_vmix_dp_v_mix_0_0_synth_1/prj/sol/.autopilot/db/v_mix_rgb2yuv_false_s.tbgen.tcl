...
set C_modelArgList {
	{ outLayer4 int 48 regular {fifo 0 volatile }  }
	{ height_val int 12 regular {ap_stable 0} }
	{ width_val int 12 regular {ap_stable 0} }
	{ outYuv int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "outLayer4", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "outYuv", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ outLayer4_dout sc_in sc_lv 48 signal 0 } 
	{ outLayer4_empty_n sc_in sc_logic 1 signal 0 } 
	{ outLayer4_read sc_out sc_logic 1 signal 0 } 
	{ outLayer4_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ outLayer4_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ height_val sc_in sc_lv 12 signal 1 } 
	{ width_val sc_in sc_lv 12 signal 2 } 
	{ outYuv_din sc_out sc_lv 48 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outLayer4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "outLayer4", "role": "dout" }} , 
 	{ "name": "outLayer4_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outLayer4", "role": "empty_n" }} , 
 	{ "name": "outLayer4_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outLayer4", "role": "read" }} , 
 	{ "name": "outLayer4_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "outLayer4", "role": "num_data_valid" }} , 
 	{ "name": "outLayer4_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "outLayer4", "role": "fifo_cap" }} , 
 	...
 	{ "name": "outYuv_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "outYuv", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "outLayer4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_rgb2yuv_false_Pipeline_VITIS_LOOP_1042_2_fu_64", "Port" : "outLayer4", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "outYuv", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_rgb2yuv_false_Pipeline_VITIS_LOOP_1042_2_fu_64", "Port" : "outYuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_1040_1", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "3", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state3"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_rgb2yuv_false_Pipeline_VITIS_LOOP_1042_2_fu_64", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_rgb2yuv_false_Pipeline_VITIS_LOOP_1042_2_fu_64.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	outLayer4 { ap_fifo {  { outLayer4_dout fifo_data_in 0 48 }  { outLayer4_empty_n fifo_status 0 1 }  { outLayer4_read fifo_port_we 1 1 }  { outLayer4_num_data_valid fifo_status_num_data_valid 0 3 }  { outLayer4_fifo_cap fifo_update 0 3 } } }
	height_val { ap_stable {  { height_val in_data 0 12 } } }
	width_val { ap_stable {  { width_val in_data 0 12 } } }
	outYuv { ap_fifo {  { outYuv_din fifo_data_in 1 48 }  { outYuv_full_n fifo_status 0 1 }  { outYuv_write fifo_port_we 1 1 }  { outYuv_num_data_valid fifo_status_num_data_valid 0 32 }  { outYuv_fifo_cap fifo_update 0 32 } } }
}
