...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video2_TDATA { I 48 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video2_TKEEP { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video2_TSTRB { I 6 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer2_din { O 48 vector } srcLayer2_full_n { I 1 bit } srcLayer2_write { O 1 bit } srcLayer2_num_data_valid { I 3 vector } srcLayer2_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 275 \
    name HwReg_layerEnableFlag_2_val_c32 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerEnableFlag_2_val_c32 \
    op interface \
    ports { HwReg_layerEnableFlag_2_val_c32_din { O 1 vector } HwReg_layerEnableFlag_2_val_c32_full_n { I 1 bit } HwReg_layerEnableFlag_2_val_c32_write { O 1 bit } HwReg_layerEnableFlag_2_val_c32_num_data_valid { I 3 vector } HwReg_layerEnableFlag_2_val_c32_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 276 \
    name HwReg_layerWidth_2_val_c46 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerWidth_2_val_c46 \
    op interface \
    ports { HwReg_layerWidth_2_val_c46_din { O 16 vector } HwReg_layerWidth_2_val_c46_full_n { I 1 bit } HwReg_layerWidth_2_val_c46_write { O 1 bit } HwReg_layerWidth_2_val_c46_num_data_valid { I 3 vector } HwReg_layerWidth_2_val_c46_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 277 \
    name HwReg_layerHeight_2_val_c62 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_layerHeight_2_val_c62 \
    op interface \
    ports { HwReg_layerHeight_2_val_c62_din { O 16 vector } HwReg_layerHeight_2_val_c62_full_n { I 1 bit } HwReg_layerHeight_2_val_c62_write { O 1 bit } HwReg_layerHeight_2_val_c62_num_data_valid { I 3 vector } HwReg_layerHeight_2_val_c62_fifo_cap { I 3 vector } } \
} "
}
