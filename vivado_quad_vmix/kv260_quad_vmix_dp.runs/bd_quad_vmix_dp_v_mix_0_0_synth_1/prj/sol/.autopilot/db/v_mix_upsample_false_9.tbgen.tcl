...
set C_modelArgList {
	{ srcLayer1Rgb int 48 regular {fifo 0 volatile }  }
	...
	{ srcLayer1x int 48 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer1Rgb", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "srcLayer1x", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ srcLayer1Rgb_dout sc_in sc_lv 48 signal 0 } 
	...
	{ srcLayer1x_din sc_out sc_lv 48 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer1Rgb_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer1Rgb", "role": "dout" }} , 
 	...
 	{ "name": "srcLayer1x_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer1x", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer1Rgb", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_9_Pipeline_VITIS_LOOP_107_2_fu_100", "Port" : "srcLayer1Rgb", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer1x", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_9_Pipeline_VITIS_LOOP_107_2_fu_100", "Port" : "srcLayer1x", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_9_Pipeline_VITIS_LOOP_107_2_fu_100", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_9_Pipeline_VITIS_LOOP_107_2_fu_100.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer1Rgb { ap_fifo {  { srcLayer1Rgb_dout fifo_data_in 0 48 }  { srcLayer1Rgb_empty_n fifo_status 0 1 }  { srcLayer1Rgb_read fifo_port_we 1 1 }  { srcLayer1Rgb_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer1Rgb_fifo_cap fifo_update 0 3 } } }
	...
	srcLayer1x { ap_fifo {  { srcLayer1x_din fifo_data_in 1 48 }  { srcLayer1x_full_n fifo_status 0 1 }  { srcLayer1x_write fifo_port_we 1 1 }  { srcLayer1x_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer1x_fifo_cap fifo_update 0 32 } } }
	HwReg_layerWidth_1_val_c { ap_fifo {  { HwReg_layerWidth_1_val_c_din fifo_data_in 1 16 }  { HwReg_layerWidth_1_val_c_full_n fifo_status 0 1 }  { HwReg_layerWidth_1_val_c_write fifo_port_we 1 1 }  { HwReg_layerWidth_1_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerWidth_1_val_c_fifo_cap fifo_update 0 3 } } }
	HwReg_layerHeight_1_val_c { ap_fifo {  { HwReg_layerHeight_1_val_c_din fifo_data_in 1 16 }  { HwReg_layerHeight_1_val_c_full_n fifo_status 0 1 }  { HwReg_layerHeight_1_val_c_write fifo_port_we 1 1 }  { HwReg_layerHeight_1_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerHeight_1_val_c_fifo_cap fifo_update 0 3 } } }
}
