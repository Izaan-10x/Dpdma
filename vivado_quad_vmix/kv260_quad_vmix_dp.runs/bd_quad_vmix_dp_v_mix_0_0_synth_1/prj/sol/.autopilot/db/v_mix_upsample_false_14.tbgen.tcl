set moduleName v_mix_upsample_false_14
set isTopModule 0
...
set cdfgNum 82
set C_modelName {v_mix_upsample<false>.14}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ srcLayer2Rgb int 48 regular {fifo 0 volatile }  }
	...
	{ srcLayer2x int 48 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer2Rgb", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "srcLayer2x", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ srcLayer2Rgb_dout sc_in sc_lv 48 signal 0 } 
	...
	{ srcLayer2x_din sc_out sc_lv 48 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer2Rgb_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer2Rgb", "role": "dout" }} , 
 	...
 	{ "name": "srcLayer2x_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer2x", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer2Rgb", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_14_Pipeline_VITIS_LOOP_107_2_fu_100", "Port" : "srcLayer2Rgb", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer2x", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_upsample_false_14_Pipeline_VITIS_LOOP_107_2_fu_100", "Port" : "srcLayer2x", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_14_Pipeline_VITIS_LOOP_107_2_fu_100", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_upsample_false_14_Pipeline_VITIS_LOOP_107_2_fu_100.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer2Rgb { ap_fifo {  { srcLayer2Rgb_dout fifo_data_in 0 48 }  { srcLayer2Rgb_empty_n fifo_status 0 1 }  { srcLayer2Rgb_read fifo_port_we 1 1 }  { srcLayer2Rgb_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer2Rgb_fifo_cap fifo_update 0 3 } } }
	...
	srcLayer2x { ap_fifo {  { srcLayer2x_din fifo_data_in 1 48 }  { srcLayer2x_full_n fifo_status 0 1 }  { srcLayer2x_write fifo_port_we 1 1 }  { srcLayer2x_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer2x_fifo_cap fifo_update 0 32 } } }
	HwReg_layerWidth_2_val_c { ap_fifo {  { HwReg_layerWidth_2_val_c_din fifo_data_in 1 16 }  { HwReg_layerWidth_2_val_c_full_n fifo_status 0 1 }  { HwReg_layerWidth_2_val_c_write fifo_port_we 1 1 }  { HwReg_layerWidth_2_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerWidth_2_val_c_fifo_cap fifo_update 0 3 } } }
	HwReg_layerHeight_2_val_c { ap_fifo {  { HwReg_layerHeight_2_val_c_din fifo_data_in 1 16 }  { HwReg_layerHeight_2_val_c_full_n fifo_status 0 1 }  { HwReg_layerHeight_2_val_c_write fifo_port_we 1 1 }  { HwReg_layerHeight_2_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerHeight_2_val_c_fifo_cap fifo_update 0 3 } } }
}
