set moduleName AXIvideo2MultiPixStream_15_Pipeline_loop_width
set isTopModule 0
...
set cdfgNum 82
set C_modelName {AXIvideo2MultiPixStream.15_Pipeline_loop_width}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ sof_7 int 1 regular  }
	{ axi_last_12 int 1 regular  }
	{ axi_data_10 int 48 regular  }
	...
	{ axi_data_11_out int 48 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "sof_7", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_10", "interface" : "wire", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_11_out", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_axis_video3_TVALID sc_in sc_logic 1 invld 5 } 
	{ srcLayer3_din sc_out sc_lv 48 signal 4 } 
	{ srcLayer3_full_n sc_in sc_logic 1 signal 4 } 
	{ srcLayer3_write sc_out sc_logic 1 signal 4 } 
	{ srcLayer3_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ srcLayer3_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ sof_7 sc_in sc_lv 1 signal 0 } 
	{ axi_last_12 sc_in sc_lv 1 signal 1 } 
	{ axi_data_10 sc_in sc_lv 48 signal 2 } 
	{ trunc_ln7 sc_in sc_lv 11 signal 3 } 
	{ s_axis_video3_TDATA sc_in sc_lv 48 signal 5 } 
	{ s_axis_video3_TREADY sc_out sc_logic 1 inacc 11 } 
	{ s_axis_video3_TKEEP sc_in sc_lv 6 signal 6 } 
	{ s_axis_video3_TSTRB sc_in sc_lv 6 signal 7 } 
	{ s_axis_video3_TUSER sc_in sc_lv 1 signal 8 } 
	{ s_axis_video3_TLAST sc_in sc_lv 1 signal 9 } 
	{ s_axis_video3_TID sc_in sc_lv 1 signal 10 } 
	{ s_axis_video3_TDEST sc_in sc_lv 1 signal 11 } 
	{ eol_out sc_out sc_lv 1 signal 12 } 
	{ eol_out_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ axi_data_11_out sc_out sc_lv 48 signal 13 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_axis_video3_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "s_axis_video3_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "axi_data_10", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_10", "role": "default" }} , 
 	...
 	{ "name": "axi_data_11_out", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "axi_data_11_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	axi_data_10 { ap_none {  { axi_data_10 in_data 0 48 } } }
	...
	s_axis_video3_V_data_V { axis {  { s_axis_video3_TVALID in_vld 0 1 }  { s_axis_video3_TDATA in_data 0 48 } } }
	...
	s_axis_video3_V_dest_V { axis {  { s_axis_video3_TREADY in_acc 1 1 }  { s_axis_video3_TDEST in_data 0 1 } } }
	eol_out { ap_vld {  { eol_out out_data 1 1 }  { eol_out_ap_vld out_vld 1 1 } } }
	axi_data_11_out { ap_vld {  { axi_data_11_out out_data 1 48 }  { axi_data_11_out_ap_vld out_vld 1 1 } } }
}
