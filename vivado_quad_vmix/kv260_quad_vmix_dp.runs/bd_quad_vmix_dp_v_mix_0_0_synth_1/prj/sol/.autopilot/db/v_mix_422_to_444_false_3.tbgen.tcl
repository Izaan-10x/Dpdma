...
set C_modelArgMapList {[ 
	{ "Name" : "srcLayer0Yuv422", "interface" : "fifo", "bitwidth" : 48, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "srcLayer0Yuv", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ srcLayer0Yuv422_dout sc_in sc_lv 48 signal 0 } 
	...
	{ srcLayer0Yuv_din sc_out sc_lv 48 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer0Yuv422_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer0Yuv422", "role": "dout" }} , 
 	...
 	{ "name": "srcLayer0Yuv_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "srcLayer0Yuv", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "srcLayer0Yuv422", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_96", "Port" : "srcLayer0Yuv422", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "srcLayer0Yuv", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_96", "Port" : "srcLayer0Yuv", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_96", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_mix_422_to_444_false_3_Pipeline_VITIS_LOOP_105_2_fu_96.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	srcLayer0Yuv422 { ap_fifo {  { srcLayer0Yuv422_dout fifo_data_in 0 48 }  { srcLayer0Yuv422_empty_n fifo_status 0 1 }  { srcLayer0Yuv422_read fifo_port_we 1 1 }  { srcLayer0Yuv422_num_data_valid fifo_status_num_data_valid 0 3 }  { srcLayer0Yuv422_fifo_cap fifo_update 0 3 } } }
	...
	srcLayer0Yuv { ap_fifo {  { srcLayer0Yuv_din fifo_data_in 1 48 }  { srcLayer0Yuv_full_n fifo_status 0 1 }  { srcLayer0Yuv_write fifo_port_we 1 1 }  { srcLayer0Yuv_num_data_valid fifo_status_num_data_valid 0 32 }  { srcLayer0Yuv_fifo_cap fifo_update 0 32 } } }
	HwReg_layerEnableFlag_0_val_c { ap_fifo {  { HwReg_layerEnableFlag_0_val_c_din fifo_data_in 1 1 }  { HwReg_layerEnableFlag_0_val_c_full_n fifo_status 0 1 }  { HwReg_layerEnableFlag_0_val_c_write fifo_port_we 1 1 }  { HwReg_layerEnableFlag_0_val_c_num_data_valid fifo_status_num_data_valid 0 3 }  { HwReg_layerEnableFlag_0_val_c_fifo_cap fifo_update 0 3 } } }
}
