...
entity bd_quad_vmix_dp_v_mix_0_0_CTRL_s_axi is
generic (
...
end entity bd_quad_vmix_dp_v_mix_0_0_CTRL_s_axi;
...
architecture behave of bd_quad_vmix_dp_v_mix_0_0_CTRL_s_axi is
    ...
    constant ADDR_LAYERALPHA_3_DATA_0       : INTEGER := 16#400#;
    constant ADDR_LAYERALPHA_3_CTRL         : INTEGER := 16#404#;
    constant ADDR_LAYERSTARTX_3_DATA_0      : INTEGER := 16#408#;
    constant ADDR_LAYERSTARTX_3_CTRL        : INTEGER := 16#40c#;
    constant ADDR_LAYERSTARTY_3_DATA_0      : INTEGER := 16#410#;
    constant ADDR_LAYERSTARTY_3_CTRL        : INTEGER := 16#414#;
    constant ADDR_LAYERWIDTH_3_DATA_0       : INTEGER := 16#418#;
    constant ADDR_LAYERWIDTH_3_CTRL         : INTEGER := 16#41c#;
    constant ADDR_LAYERSTRIDE_3_DATA_0      : INTEGER := 16#420#;
    constant ADDR_LAYERSTRIDE_3_CTRL        : INTEGER := 16#424#;
    constant ADDR_LAYERHEIGHT_3_DATA_0      : INTEGER := 16#428#;
    constant ADDR_LAYERHEIGHT_3_CTRL        : INTEGER := 16#42c#;
    constant ADDR_LAYERSCALEFACTOR_3_DATA_0 : INTEGER := 16#430#;
    constant ADDR_LAYERSCALEFACTOR_3_CTRL   : INTEGER := 16#434#;
    constant ADDR_LAYERALPHA_4_DATA_0       : INTEGER := 16#500#;
    constant ADDR_LAYERALPHA_4_CTRL         : INTEGER := 16#504#;
    constant ADDR_LAYERSTARTX_4_DATA_0      : INTEGER := 16#508#;
    constant ADDR_LAYERSTARTX_4_CTRL        : INTEGER := 16#50c#;
    constant ADDR_LAYERSTARTY_4_DATA_0      : INTEGER := 16#510#;
    constant ADDR_LAYERSTARTY_4_CTRL        : INTEGER := 16#514#;
    constant ADDR_LAYERWIDTH_4_DATA_0       : INTEGER := 16#518#;
    constant ADDR_LAYERWIDTH_4_CTRL         : INTEGER := 16#51c#;
    constant ADDR_LAYERSTRIDE_4_DATA_0      : INTEGER := 16#520#;
    constant ADDR_LAYERSTRIDE_4_CTRL        : INTEGER := 16#524#;
    constant ADDR_LAYERHEIGHT_4_DATA_0      : INTEGER := 16#528#;
    constant ADDR_LAYERHEIGHT_4_CTRL        : INTEGER := 16#52c#;
    constant ADDR_LAYERSCALEFACTOR_4_DATA_0 : INTEGER := 16#530#;
    constant ADDR_LAYERSCALEFACTOR_4_CTRL   : INTEGER := 16#534#;
    ...
    signal int_layerAlpha_3    : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStartX_3   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStartY_3   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerWidth_3    : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStride_3   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerHeight_3   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerScaleFactor_3 : UNSIGNED(7 downto 0) := (others => '0');
    signal int_layerAlpha_4    : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStartX_4   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStartY_4   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerWidth_4    : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerStride_4   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerHeight_4   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_layerScaleFactor_4 : UNSIGNED(7 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_LAYERALPHA_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerAlpha_3(15 downto 0), 32);
                    when ADDR_LAYERSTARTX_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStartX_3(15 downto 0), 32);
                    when ADDR_LAYERSTARTY_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStartY_3(15 downto 0), 32);
                    when ADDR_LAYERWIDTH_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerWidth_3(15 downto 0), 32);
                    when ADDR_LAYERSTRIDE_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStride_3(15 downto 0), 32);
                    when ADDR_LAYERHEIGHT_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerHeight_3(15 downto 0), 32);
                    when ADDR_LAYERSCALEFACTOR_3_DATA_0 =>
                        rdata_data <= RESIZE(int_layerScaleFactor_3(7 downto 0), 32);
                    when ADDR_LAYERALPHA_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerAlpha_4(15 downto 0), 32);
                    when ADDR_LAYERSTARTX_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStartX_4(15 downto 0), 32);
                    when ADDR_LAYERSTARTY_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStartY_4(15 downto 0), 32);
                    when ADDR_LAYERWIDTH_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerWidth_4(15 downto 0), 32);
                    when ADDR_LAYERSTRIDE_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerStride_4(15 downto 0), 32);
                    when ADDR_LAYERHEIGHT_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerHeight_4(15 downto 0), 32);
                    when ADDR_LAYERSCALEFACTOR_4_DATA_0 =>
                        rdata_data <= RESIZE(int_layerScaleFactor_4(7 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    layerAlpha_3         <= STD_LOGIC_VECTOR(int_layerAlpha_3);
    layerStartX_3        <= STD_LOGIC_VECTOR(int_layerStartX_3);
    layerStartY_3        <= STD_LOGIC_VECTOR(int_layerStartY_3);
    layerWidth_3         <= STD_LOGIC_VECTOR(int_layerWidth_3);
    layerStride_3        <= STD_LOGIC_VECTOR(int_layerStride_3);
    layerHeight_3        <= STD_LOGIC_VECTOR(int_layerHeight_3);
    layerScaleFactor_3   <= STD_LOGIC_VECTOR(int_layerScaleFactor_3);
    layerAlpha_4         <= STD_LOGIC_VECTOR(int_layerAlpha_4);
    layerStartX_4        <= STD_LOGIC_VECTOR(int_layerStartX_4);
    layerStartY_4        <= STD_LOGIC_VECTOR(int_layerStartY_4);
    layerWidth_4         <= STD_LOGIC_VECTOR(int_layerWidth_4);
    layerStride_4        <= STD_LOGIC_VECTOR(int_layerStride_4);
    layerHeight_4        <= STD_LOGIC_VECTOR(int_layerHeight_4);
    layerScaleFactor_4   <= STD_LOGIC_VECTOR(int_layerScaleFactor_4);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerAlpha_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERALPHA_3_DATA_0) then
                    int_layerAlpha_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerAlpha_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStartX_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTARTX_3_DATA_0) then
                    int_layerStartX_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStartX_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStartY_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTARTY_3_DATA_0) then
                    int_layerStartY_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStartY_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerWidth_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERWIDTH_3_DATA_0) then
                    int_layerWidth_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerWidth_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStride_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTRIDE_3_DATA_0) then
                    int_layerStride_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStride_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerHeight_3(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERHEIGHT_3_DATA_0) then
                    int_layerHeight_3(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerHeight_3(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerScaleFactor_3(7 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSCALEFACTOR_3_DATA_0) then
                    int_layerScaleFactor_3(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_layerScaleFactor_3(7 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerAlpha_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERALPHA_4_DATA_0) then
                    int_layerAlpha_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerAlpha_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStartX_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTARTX_4_DATA_0) then
                    int_layerStartX_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStartX_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStartY_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTARTY_4_DATA_0) then
                    int_layerStartY_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStartY_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerWidth_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERWIDTH_4_DATA_0) then
                    int_layerWidth_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerWidth_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerStride_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSTRIDE_4_DATA_0) then
                    int_layerStride_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerStride_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerHeight_4(15 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERHEIGHT_4_DATA_0) then
                    int_layerHeight_4(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_layerHeight_4(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layerScaleFactor_4(7 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYERSCALEFACTOR_4_DATA_0) then
                    int_layerScaleFactor_4(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_layerScaleFactor_4(7 downto 0));
                end if;
            end if;
        end if;
    end process;
