...
entity bd_quad_vmix_dp_v_tpg_2_0_tpgForeground is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_quad_vmix_dp_v_tpg_2_0_tpgForeground is 
...
attribute shreg_extract : string;
    ...
    signal empty_87_fu_292_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_87_reg_507 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground_Pipeline_VITIS_LOOP_774_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground_whiYuv_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
...
begin
    whiYuv_U : component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground_whiYuv_ROM_AUTO_1R
    generic map (
        DataWidth => 8,
        AddressRange => 3,
        AddressWidth => 2)
    ...
    grp_tpgForeground_Pipeline_VITIS_LOOP_774_2_fu_235 : component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground_Pipeline_VITIS_LOOP_774_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                ...
                empty_87_reg_507 <= empty_87_fu_292_p1;
    ...
    empty_87_fu_292_p1 <= maskId_val_dout(1 - 1 downto 0);
