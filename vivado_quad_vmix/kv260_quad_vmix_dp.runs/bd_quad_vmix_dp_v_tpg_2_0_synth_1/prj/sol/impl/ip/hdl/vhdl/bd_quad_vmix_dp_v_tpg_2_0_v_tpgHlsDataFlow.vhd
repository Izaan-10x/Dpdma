...
entity bd_quad_vmix_dp_v_tpg_2_0_v_tpgHlsDataFlow is
port (
...
architecture behav of bd_quad_vmix_dp_v_tpg_2_0_v_tpgHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_tpgBackground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_MultiPixStream2AXIvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w1_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w48_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_start_for_tpgForeground_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component bd_quad_vmix_dp_v_tpg_2_0_start_for_MultiPixStream2AXIvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component bd_quad_vmix_dp_v_tpg_2_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    tpgBackground_U0 : component bd_quad_vmix_dp_v_tpg_2_0_tpgBackground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    tpgForeground_U0 : component bd_quad_vmix_dp_v_tpg_2_0_tpgForeground
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2AXIvideo_U0 : component bd_quad_vmix_dp_v_tpg_2_0_MultiPixStream2AXIvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    field_id_val8_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    fid_in_val9_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w1_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayId_val11_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    maskId_val12_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairX_val18_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crossHairY_val19_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxSize_val20_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorR_val21_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorG_val22_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    boxColorB_val23_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bckgndYUV_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w48_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c3_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c4_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    motionSpeed_val14_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c5_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ovrlayYUV_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w48_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_val4_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_val7_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    colorFormat_val17_c_U : component bd_quad_vmix_dp_v_tpg_2_0_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_tpgForeground_U0_U : component bd_quad_vmix_dp_v_tpg_2_0_start_for_tpgForeground_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2AXIvideo_U0_U : component bd_quad_vmix_dp_v_tpg_2_0_start_for_MultiPixStream2AXIvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
