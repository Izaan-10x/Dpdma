...
set Spec2ImplPortList { 
	...
	boxSize_val24_c { ap_fifo {  { boxSize_val24_c_din fifo_data_in 1 16 }  { boxSize_val24_c_full_n fifo_status 0 1 }  { boxSize_val24_c_write fifo_port_we 1 1 }  { boxSize_val24_c_num_data_valid fifo_status_num_data_valid 0 3 }  { boxSize_val24_c_fifo_cap fifo_update 0 3 } } }
	boxColorR_val25 { ap_none {  { boxColorR_val25 in_data 0 8 } } }
	boxColorR_val25_c { ap_fifo {  { boxColorR_val25_c_din fifo_data_in 1 8 }  { boxColorR_val25_c_full_n fifo_status 0 1 }  { boxColorR_val25_c_write fifo_port_we 1 1 }  { boxColorR_val25_c_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorR_val25_c_fifo_cap fifo_update 0 3 } } }
	boxColorG_val26 { ap_none {  { boxColorG_val26 in_data 0 8 } } }
	boxColorG_val26_c { ap_fifo {  { boxColorG_val26_c_din fifo_data_in 1 8 }  { boxColorG_val26_c_full_n fifo_status 0 1 }  { boxColorG_val26_c_write fifo_port_we 1 1 }  { boxColorG_val26_c_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorG_val26_c_fifo_cap fifo_update 0 3 } } }
	boxColorB_val27 { ap_none {  { boxColorB_val27 in_data 0 8 } } }
	boxColorB_val27_c { ap_fifo {  { boxColorB_val27_c_din fifo_data_in 1 8 }  { boxColorB_val27_c_full_n fifo_status 0 1 }  { boxColorB_val27_c_write fifo_port_we 1 1 }  { boxColorB_val27_c_num_data_valid fifo_status_num_data_valid 0 3 }  { boxColorB_val27_c_fifo_cap fifo_update 0 3 } } }
}
