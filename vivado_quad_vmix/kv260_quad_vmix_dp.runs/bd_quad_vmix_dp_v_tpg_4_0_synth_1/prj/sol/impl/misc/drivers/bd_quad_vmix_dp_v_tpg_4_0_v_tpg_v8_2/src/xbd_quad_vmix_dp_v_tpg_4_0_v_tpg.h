...
// 
// ==============================================================
#ifndef XBD_QUAD_VMIX_DP_V_TPG_4_0_V_TPG_H
#define XBD_QUAD_VMIX_DP_V_TPG_4_0_V_TPG_H
...
#include <stddef.h>
#endif
#include "xbd_quad_vmix_dp_v_tpg_4_0_v_tpg_hw.h"
...
typedef struct {
    ...
    u16 DeviceId;
#endif
    u64 Bd_quad_vmix_dp_v_tpg_4_0_ctrl_BaseAddress;
} XBd_quad_vmix_dp_v_tpg_4_0_v_tpg_Config;
#endif

typedef struct {
    u64 Bd_quad_vmix_dp_v_tpg_4_0_ctrl_BaseAddress;
    u32 IsReady;
} XBd_quad_vmix_dp_v_tpg_4_0_v_tpg;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XBd_quad_vmix_dp_v_tpg_4_0_v_tpg_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XBd_quad_vmix_dp_v_tpg_4_0_v_tpg_ReadReg(BaseAddress, RegOffset) \
