...
entity bd_quad_vmix_dp_v_tpg_4_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity bd_quad_vmix_dp_v_tpg_4_0_regslice_both;

architecture behave of bd_quad_vmix_dp_v_tpg_4_0_regslice_both is
