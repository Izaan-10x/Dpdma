...
HD_PWD='/home/izaan/GitRepos/dpdma_exdes/vivado_quad_vmix/kv260_quad_vmix_dp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_quad_vmix_dp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_quad_vmix_dp_wrapper.tcl
