...
module bd_quad_vmix_dp_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1504_fu_110_p2;
...
reg   [127:0] bytePlanes_read_reg_149;
reg    ap_block_pp0_stage0_01001_grp1;
reg   [10:0] x_fu_68;
wire   [10:0] add_ln1504_fu_116_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1504_fu_110_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1504_fu_110_p2 == 1'd1))) begin
...
assign add_ln1504_fu_116_p2 = (ap_sig_allocacmp_x_5 + 11'd1);
...
assign icmp_ln1504_fu_110_p2 = ((ap_sig_allocacmp_x_5 == loopWidth) ? 1'b1 : 1'b0);
...
assign m_axi_mm_video_0_WDATA = bytePlanes_read_reg_149;
...
endmodule //bd_quad_vmix_dp_v_frmbuf_wr_0_0_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1
