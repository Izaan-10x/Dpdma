; ModuleID = '/home/izaan/GitRepos/dpdma_exdes/vivado_quad_vmix/kv260_quad_vmix_dp.runs/bd_quad_vmix_dp_v_frmbuf_wr_0_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @copy_in([2073600 x %"struct.ap_uint<128>"]* nonnull %0, [2073600 x i128]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<128>"]* nonnull %2, [2073600 x i128]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<128>"]* nonnull %5, [2073600 x i128]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* nonnull %s_axis_video, i48* nonnull align 512 %s_axis_video_copy.data, i6* nonnull align 512 %s_axis_video_copy.keep, i6* nonnull align 512 %s_axis_video_copy.strb, i1* nonnull align 512 %s_axis_video_copy.user, i1* nonnull align 512 %s_axis_video_copy.last, i1* nonnull align 512 %s_axis_video_copy.id, i1* nonnull align 512 %s_axis_video_copy.dest)
  call void @apatb_v_frmbuf_wr_hw(i16 %width, i16 %height, i16 %stride, i16 %video_format, [2073600 x i128]* %frm_buffer_copy, i128* %4, i128* %7, i48* %s_axis_video_copy.data, i6* %s_axis_video_copy.keep, i6* %s_axis_video_copy.strb, i1* %s_axis_video_copy.user, i1* %s_axis_video_copy.last, i1* %s_axis_video_copy.id, i1* %s_axis_video_copy.dest)
  call void @copy_back([2073600 x %"struct.ap_uint<128>"]* %0, [2073600 x i128]* %frm_buffer_copy, [2073600 x %"struct.ap_uint<128>"]* %2, [2073600 x i128]* %frm_buffer2_copy, [2073600 x %"struct.ap_uint<128>"]* %5, [2073600 x i128]* %frm_buffer3_copy, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* %s_axis_video, i48* %s_axis_video_copy.data, i6* %s_axis_video_copy.keep, i6* %s_axis_video_copy.strb, i1* %s_axis_video_copy.user, i1* %s_axis_video_copy.last, i1* %s_axis_video_copy.id, i1* %s_axis_video_copy.dest)
  call void @free(i8* %1)
  call void @free(i8* %3)
  call void @free(i8* %6)
  ret void
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>.45"(i48* align 512 %_V_data_V, i6* align 512 %_V_keep_V, i6* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* %6)
  ret void
}
...
define internal fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<128>.13"([2073600 x %"struct.ap_uint<128>"]* "unpacked"="0" %dst, [2073600 x i128]* nocapture readonly "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>.45"(i48* align 512 "unpacked"="0.0" %dst_V_data_V, i6* align 512 "unpacked"="0.1" %dst_V_keep_V, i6* align 512 "unpacked"="0.2" %dst_V_strb_V, i1* align 512 "unpacked"="0.3" %dst_V_user_V, i1* align 512 "unpacked"="0.4" %dst_V_last_V, i1* align 512 "unpacked"="0.5" %dst_V_id_V, i1* align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>.48"(i48* align 512 %dst_V_data_V, i6* align 512 %dst_V_keep_V, i6* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>.48"(i48* nocapture align 512 "unpacked"="0.0" %_V_data_V, i6* nocapture align 512 "unpacked"="0.1" %_V_keep_V, i6* nocapture align 512 "unpacked"="0.2" %_V_strb_V, i1* nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* nocapture align 512 "unpacked"="0.4" %_V_last_V, i1* nocapture align 512 "unpacked"="0.5" %_V_id_V, i1* nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* nocapture) unnamed_addr #3 {
entry:
...
declare void @apatb_v_frmbuf_wr_hw(i16, i16, i16, i16, [2073600 x i128]*, i128*, i128*, i48*, i6*, i6*, i1*, i1*, i1*, i1*)
...
define void @v_frmbuf_wr_hw_stub_wrapper(i16, i16, i16, i16, [2073600 x i128]*, i128*, i128*, i48*, i6*, i6*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  call void @v_frmbuf_wr_hw_stub(i16 %0, i16 %1, i16 %2, i16 %3, %"struct.ap_uint<128>"* %24, %"struct.ap_uint<128>"* %25, %"struct.ap_uint<128>"* %26, %"class.hls::stream<hls::axis<ap_uint<48>, 1, 1, 1, '8', false>, 0>"* %23)
