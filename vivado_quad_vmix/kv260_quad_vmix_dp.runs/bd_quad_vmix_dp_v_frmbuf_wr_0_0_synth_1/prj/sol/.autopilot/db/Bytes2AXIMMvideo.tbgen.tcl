...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "bytePlanes", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "481", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1_fu_145", "Port" : "bytePlanes", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "mm_video", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "mm_video_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "mm_video_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1_fu_145", "Port" : "mm_video", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1_fu_145", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1504_1_fu_145.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7041", "Max" : "3350161"}
	, {"Name" : "Interval", "Min" : "7041", "Max" : "3350161"}
]}
...
set Spec2ImplPortList { 
	bytePlanes { ap_fifo {  { bytePlanes_dout fifo_data_in 0 128 }  { bytePlanes_empty_n fifo_status 0 1 }  { bytePlanes_read fifo_port_we 1 1 }  { bytePlanes_num_data_valid fifo_status_num_data_valid 0 10 }  { bytePlanes_fifo_cap fifo_update 0 10 } } }
	...
	dstImg { ap_fifo {  { dstImg_dout fifo_data_in 0 32 }  { dstImg_empty_n fifo_status 0 1 }  { dstImg_read fifo_port_we 1 1 }  { dstImg_num_data_valid fifo_status_num_data_valid 0 3 }  { dstImg_fifo_cap fifo_update 0 3 } } }
