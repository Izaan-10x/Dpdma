...
entity bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S is 
    generic (
...
architecture rtl of bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 48;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg : bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg
    generic map (
...
entity bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 48;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg;

architecture rtl of bd_quad_vmix_dp_v_frmbuf_wr_0_0_fifo_w48_d2_S_ShiftReg is
