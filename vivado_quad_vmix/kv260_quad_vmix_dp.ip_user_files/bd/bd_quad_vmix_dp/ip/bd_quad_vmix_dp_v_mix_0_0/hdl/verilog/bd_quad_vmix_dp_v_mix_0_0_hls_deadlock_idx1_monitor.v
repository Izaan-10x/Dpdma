...
module bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx1_monitor ( // for module bd_quad_vmix_dp_v_mix_0_0_v_mix_inst.grp_VMixHlsDataFlowFunction_fu_676
    input wire clock,
    input wire reset,
...
wire idx18_block;
wire idx22_block;
wire [32:0] process_idle_vec;
wire [32:0] process_chan_block_vec;
wire [32:0] process_axis_block_vec;
wire df_has_axis_block;
wire all_process_stop;

assign block = monitor_find_block;
assign idx22_block = axis_block_sigs[15];
...
assign process_axis_block_vec[5] = idx6_block & (1'b0 | axis_block_sigs[3] | axis_block_sigs[4] | axis_block_sigs[5]);
...
assign process_axis_block_vec[11] = idx10_block & (1'b0 | axis_block_sigs[6] | axis_block_sigs[7] | axis_block_sigs[8]);
...
assign process_axis_block_vec[17] = idx14_block & (1'b0 | axis_block_sigs[9] | axis_block_sigs[10] | axis_block_sigs[11]);
...
assign process_axis_block_vec[23] = idx18_block & (1'b0 | axis_block_sigs[12] | axis_block_sigs[13] | axis_block_sigs[14]);
...
// instant sub module
 bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx2_monitor bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx6_monitor bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx6_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx10_monitor bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx10_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx14_monitor bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx14_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx18_monitor bd_quad_vmix_dp_v_mix_0_0_hls_deadlock_idx18_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
